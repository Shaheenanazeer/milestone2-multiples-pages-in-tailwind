    ...
    <div>
      ...
      >
        <div className="text-center">
          ...
          <button className="px-4 py-2 bg-green-500 text-white font-semibold rounded-full shadow-md hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-opacity-50">
  Shop now
</button>
